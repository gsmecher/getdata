...
#define _GD_ZstdName lt_libgetdatazstd_LTX_GD_ZstdName
...
/* zstd I/O methods */
int _GD_ZstdName(DIRFILE *restrict, const char *restrict,
    struct gd_raw_file_ *restrict, const char *restrict, int, int);
int _GD_ZstdOpen(int, struct gd_raw_file_*, gd_type_t, int, unsigned int);
