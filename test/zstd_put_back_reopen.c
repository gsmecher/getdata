 ...
 */
/* Test _GD_ZstdScanFrames on a file that has been rewritten by RewriteFrom.
...
int main(void)
{
  ...
  /* Backward write at frame 0: triggers RewriteFrom on committed frames */
  ...
  /* Reopen read-only: exercises ScanFrames on the rewritten file */
